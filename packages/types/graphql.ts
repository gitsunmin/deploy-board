...
export type AdminSubscriptionSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type AdminSubscriptionSubscription = { __typename?: 'Subscription', deploymentCreated: Array<{ __typename?: 'Deployment', id: string, name: string, status: DeploymentStatus, deployer: string, description?: string | null, createdAt: string, updatedAt: string }> };
...
export const AdminSubscriptionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"AdminSubscription"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deploymentCreated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"deployer"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<AdminSubscriptionSubscription, AdminSubscriptionSubscriptionVariables>;
