...
export type UpdateDeploymentMutation = { __typename?: 'Mutation', updateDeployment: { __typename?: 'Deployment', id: string, name: string, description?: string | null, deployer: string, status: DeploymentStatus, dependsOn?: Array<string> | null } };
...
export type DeploymentQuery = { __typename?: 'Query', node?: { __typename: 'Deployment', id: string, name: string, description?: string | null, deployer: string, status: DeploymentStatus, dependsOn?: Array<string> | null } | null };

export type DeploymentCompleteMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  input: DeploymentInput;
}>;


export type DeploymentCompleteMutation = { __typename?: 'Mutation', updateDeployment: { __typename?: 'Deployment', id: string, name: string, description?: string | null, deployer: string } };

export type AdminPageQueryVariables = Exact<{ [key: string]: never; }>;


export type AdminPageQuery = { __typename?: 'Query', document: { __typename?: 'Document', title: string, description: string }, deployments: Array<{ __typename?: 'Deployment', id: string, name: string, status: DeploymentStatus, deployer: string, description?: string | null, dependsOn?: Array<string> | null, createdAt: string, updatedAt: string }> };

export type AdminDeploymentCreatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type AdminDeploymentCreatedSubscription = { __typename?: 'Subscription', deploymentCreated: Array<{ __typename?: 'Deployment', id: string, name: string, status: DeploymentStatus, deployer: string, description?: string | null, dependsOn?: Array<string> | null, createdAt: string, updatedAt: string }> };

export type AdminDeploymentUpdatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type AdminDeploymentUpdatedSubscription = { __typename?: 'Subscription', deploymentUpdated: Array<{ __typename?: 'Deployment', id: string, name: string, status: DeploymentStatus, deployer: string, description?: string | null, dependsOn?: Array<string> | null, createdAt: string, updatedAt: string }> };

export type AdminDeploymentDeletedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type AdminDeploymentDeletedSubscription = { __typename?: 'Subscription', deploymentDeleted: Array<{ __typename?: 'Deployment', id: string, name: string, status: DeploymentStatus, deployer: string, description?: string | null, dependsOn?: Array<string> | null, createdAt: string, updatedAt: string }> };

export type IndexPageQueryVariables = Exact<{ [key: string]: never; }>;


export type IndexPageQuery = { __typename?: 'Query', document: { __typename?: 'Document', title: string, description: string }, deployments: Array<{ __typename?: 'Deployment', id: string, name: string, status: DeploymentStatus, deployer: string, description?: string | null, dependsOn?: Array<string> | null, createdAt: string, updatedAt: string }> };

export type IndexDeploymentCreatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type IndexDeploymentCreatedSubscription = { __typename?: 'Subscription', deploymentCreated: Array<{ __typename?: 'Deployment', id: string, name: string, status: DeploymentStatus, deployer: string, description?: string | null, dependsOn?: Array<string> | null, createdAt: string, updatedAt: string }> };

export type IndexDeploymentUpdatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type IndexDeploymentUpdatedSubscription = { __typename?: 'Subscription', deploymentUpdated: Array<{ __typename?: 'Deployment', id: string, name: string, status: DeploymentStatus, deployer: string, description?: string | null, dependsOn?: Array<string> | null, createdAt: string, updatedAt: string }> };

export type IndexDeploymentDeletedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type IndexDeploymentDeletedSubscription = { __typename?: 'Subscription', deploymentDeleted: Array<{ __typename?: 'Deployment', id: string, name: string, status: DeploymentStatus, deployer: string, description?: string | null, dependsOn?: Array<string> | null, createdAt: string, updatedAt: string }> };

export type IndexDocumentUpdatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type IndexDocumentUpdatedSubscription = { __typename?: 'Subscription', documentUpdated: { __typename?: 'Document', title: string, description: string } };
...
export const DeploymentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Deployment"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"deployId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"node"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"deployId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Deployment"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"deployer"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"dependsOn"}}]}}]}}]}}]} as unknown as DocumentNode<DeploymentQuery, DeploymentQueryVariables>;
export const DeploymentCompleteDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeploymentComplete"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DeploymentInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateDeployment"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"deployer"}}]}}]}}]} as unknown as DocumentNode<DeploymentCompleteMutation, DeploymentCompleteMutationVariables>;
...
export const IndexDocumentUpdatedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"IndexDocumentUpdated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"documentUpdated"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]}}]} as unknown as DocumentNode<IndexDocumentUpdatedSubscription, IndexDocumentUpdatedSubscriptionVariables>;